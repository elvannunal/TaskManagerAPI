...
namespace TaskManagerAPI.Persistence.Migrations
{
    ...
    [Migration("20240208145523_mig_4")]
    partial class mig4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagerAPI.Domain.Entities.SubTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaskManagerAPI.Domain.Entities.UserRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("TaskManagerAPI.Domain.Entities.UserRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManagerAPI.Domain.Entities.SubTask", b =>
                {
                    b.HasOne("TaskManagerAPI.Domain.Entities.UserTask", null)
                        .WithMany("SubTasks")
